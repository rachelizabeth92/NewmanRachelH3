public class SCircList
{
  ...
  private String insertBefore(String element)
  {
  ...
  private String insertAfter(String element)
  {
    Node node = new Node(element);
  ...
  public String insertList(String element)
  {
    Node node;
